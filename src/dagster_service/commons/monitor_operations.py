...
@op
def get_data(source_url: str) -> dict:
    """
...
@op
def get_data_from_notification(data_source: dict, attributes: List[str]) -> tuple[List[float], str]:
    """
    ...
    try:
        values = [data_source[attribute]["value"]["value"] for attribute in attributes]
